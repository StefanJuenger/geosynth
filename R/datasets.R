...
#'   \item{ags_YEAR}{German municipality identifier for the corresponding year ("Allgemeiner Gemeindeschlüssel")}
#' }
#'
...
#'   \item{regiostar17}{3- digit regional spatial statistic type identifier "Regionalstatistische Raumtypologie, Regionalstatischer Raumtyp", \url{see https://www.bmv.de/SharedDocs/DE/Artikel/G/regionalstatistische-raumtypologie.html}}
